...
**/etc/resolv.conf** file is known as configuration file for DNS Queries. <br/>
...
⦿ We've now the coreDNS pod up and running using the appropriate Kubernetes Plugin. <br/>
